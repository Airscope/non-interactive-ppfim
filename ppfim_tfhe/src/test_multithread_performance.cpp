...
int main() {
    ...
    for (int thread_num = 2; thread_num <= kCPUCores; ++thread_num) {
        ...
        for (int j = 0; j < test_times; ++j) {
            ...
            ppfim::parallel_freq_itemset_mining_first(mining_result, thread_num, ctxt_data_matrix, m, n, ctxt_query,
            ...
            time_start = std::chrono::high_resolution_clock::now();
            ppfim::parallel_freq_itemset_mining_second(mining_result, thread_num, ctxt_data_matrix, m, n, ptxt_query,
                                                       ctxt_min_supp_count, k, cloud_key);
            time_finish = std::chrono::high_resolution_clock::now();
